...
//It is guaranteed that no two events on the same day intersect in time, and in_
//time < out_time.
// 
//
// 
...
//employee on each day at the office. Note that within one day, an employee can enter 
//and leave more than once. The time spent in the office for a single entry is out_
//time - in_time. 
//

...
//+-------------+-------+
//Explanation: 
//The employees with IDs 2 and 8 get 0 bonus because they have an even employee_
//id.
//The employee with ID 3 gets 0 bonus because their name starts with 'M'.
//The rest of the employees get a 100% bonus.
// 
//
// Related Topics Database 👍 620 👎 47


//There is no code of Go type for this problem

select employee_id,
case when mod(employee_id,2)=1 and LEFT(name,1)!='M'
then salary
else 0 end as bonus
from Employees

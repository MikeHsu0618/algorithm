...
//
//
// Related Topics Array Depth-First Search Breadth-First Search Matrix 👍 6266 ?
//? 600

//leetcode submit region begin(Prohibit modification and deletion)
// flood fill 想像一個溢出的水會如何往旁邊擴散
// https://sprout.tw/algo2022/ppt_pdf/week03/flood_fill.pdf
...
func colorImage(image [][]int, sr, sc, color, startColor int) {
	...
	image[sr][sc] = color
	colorImage(image, sr-1, sc, color, startColor)
	colorImage(image, sr, sc-1, color, startColor)
	colorImage(image, sr+1, sc, color, startColor)
	colorImage(image, sr, sc+1, color, startColor)
}
